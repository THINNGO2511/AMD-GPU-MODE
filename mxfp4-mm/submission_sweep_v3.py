...
#!POPCORN gpu MI355X
"""
MXFP4 GEMM — Sweep Round 2 winner: BM32_BN32_GS8_W4_S2_WPE2_MI16.
Continuous coordinate descent + random exploration found optimal AMD opts.
"""
...
@triton.autotune(
    configs=[
        # Top sweep configs from Round 2
        ...
        triton.Config({'BLOCK_M': 32, 'BLOCK_N': 32, 'BLOCK_K': 128, 'GROUP_SIZE_M': 8, 'waves_per_eu': 3}, num_warps=4, num_stages=2),
        triton.Config({'BLOCK_M': 32, 'BLOCK_N': 32, 'BLOCK_K': 128, 'GROUP_SIZE_M': 8, 'waves_per_eu': 3}, num_warps=8, num_stages=2),
        triton.Config({'BLOCK_M': 32, 'BLOCK_N': 32, 'BLOCK_K': 128, 'GROUP_SIZE_M': 8, 'waves_per_eu': 1}, num_warps=4, num_stages=2),
        # Round 1 winners
