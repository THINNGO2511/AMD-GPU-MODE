...
# K=7168 config: KSPLIT=14 from runner's gfx950-GEMM-A16WFP4-N=512-K=7168.json
# (our shape is N=2112,K=7168 but these configs should transfer)
_K7168_CONFIG = {
    ...
    "cache_modifier": ".cg", "NUM_KSPLIT": 14, "SPLITK_BLOCK_SIZE": 512,
}

# K=2048 config from runner's gfx950-GEMM-A16WFP4-N=7168-K=2048.json M_LEQ_64
_K2048_CONFIG = {
