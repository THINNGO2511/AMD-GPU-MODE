...
#!POPCORN gpu MI355X
"""
MXFP4 GEMM — Test AMD-specific Triton compile options.
waves_per_eu and matrix_instr_nonkdim control occupancy and MFMA tile sizes.
"""
...
@triton.autotune(
    configs=[
        ...
        # AMD-specific: waves_per_eu controls occupancy
        ...
        # AMD-specific: matrix_instr_nonkdim controls MFMA tile size
        triton.Config({'BLOCK_M': 32, 'BLOCK_N': 64, 'BLOCK_K': 128, 'GROUP_SIZE_M': 1, 'matrix_instr_nonkdim': 16}, num_warps=8, num_stages=2),
        triton.Config({'BLOCK_M': 32, 'BLOCK_N': 64, 'BLOCK_K': 128, 'GROUP_SIZE_M': 4, 'matrix_instr_nonkdim': 16}, num_warps=4, num_stages=2),
        # Combined AMD options
