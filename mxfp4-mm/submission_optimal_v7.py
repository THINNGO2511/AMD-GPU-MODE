...
#!POPCORN gpu MI355X
"""
MXFP4 GEMM — Optimal v7: AMD's own tuned config from JSON!
From gfx950-GEMM-A16WFP4_PRESHUFFLED-N=2112-K=7168.json M_LEQ_16:
  BM=16,BN=128,BK=512,KS=14,stages=1,wpe=1,.cg
This combo was NEVER tested as a unit. Individual params were tested separately.
"""
...
# K=7168: AMD's tuned config from JSON config files
# gfx950-GEMM-A16WFP4_PRESHUFFLED-N=2112-K=7168.json, M_LEQ_16 entry
_K7168_CONFIG = {
    ...
    "NUM_KSPLIT": 14, "SPLITK_BLOCK_SIZE": 512,
}
