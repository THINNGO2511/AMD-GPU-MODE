...
#!POPCORN gpu MI355X
"""
Experiment 04: Per-shape tuned configs
Instead of using defaults for K=512 and K=2048 shapes, provide explicit
configs optimized for each shape. Targets the 4 shapes currently on defaults.

Strategy: small M → small BM, large N → large BN, short K → no split-K.
For K=512: BK=128 or 256 (since K is small), no split-K.
For K=2048: BK=512, moderate split-K.
"""
...
_CONFIGS = {
    # K=512 shapes: small K, no split-K needed, focus on BM/BN for occupancy
    (4, 2880, 512): {
