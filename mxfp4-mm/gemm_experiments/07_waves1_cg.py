...
#!POPCORN gpu MI355X
"""
Experiment 07: waves_per_eu=1 + cache_modifier=".cg" for all shapes
waves_per_eu=1 means more registers per wave (good for decode/small M).
cache_modifier=".cg" uses cache-global loads (better for streaming B data).

These are typically good for memory-bound decode-like workloads where
register pressure is low and data reuse is limited.
"""
...
def custom_kernel(data: input_t) -> output_t:
    ...
    cfg = _K7168_CONFIG if k == 7168 else _DEFAULT_W1_CONFIG
