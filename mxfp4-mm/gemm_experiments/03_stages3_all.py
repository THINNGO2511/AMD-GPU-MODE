...
#!POPCORN gpu MI355X
"""
Experiment 03: num_stages=3 for all shapes
PR #2160 claims +30% on gfx950 with num_stages=3. Test it globally.
Also uses full warmup from experiment 02.
"""
...
def custom_kernel(data: input_t) -> output_t:
    ...
    cfg = _K7168_CONFIG if k == 7168 else _DEFAULT_S3_CONFIG
