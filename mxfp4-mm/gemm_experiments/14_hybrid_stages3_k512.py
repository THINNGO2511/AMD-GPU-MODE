...
#!POPCORN gpu MI355X
"""
Experiment 14: Per-shape num_stages — stages=3 for K=512, stages=2 for K=2048/7168
Exp 03 showed stages=3 helps K=512 shapes (~5-8% faster) but kills K=2048 (+34%).
This hybrid uses stages=3 only where it helps.
"""
...
# K=512: stages=3 (proven better in exp 03)
_K512_S3_CONFIG = {
...
def custom_kernel(data: input_t) -> output_t:
    ...
    if k == 7168:
        ...
        cfg = None  # K=2048 uses default (stages=2)
