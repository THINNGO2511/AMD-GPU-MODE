...
#!POPCORN gpu MI355X
"""
MXFP4 GEMM — Hybrid: fused kernel for small K, gemm_afp4wfp4 for large K.

- K=512: Fused quant+GEMM (single kernel, ~9us vs 11us with 2 kernels)
- K>=1536: Separate quant + gemm_afp4wfp4 (tuned configs, ~15-24us)
"""
...
def custom_kernel(data: input_t) -> output_t:
    ...
    if k <= 1024:
        # FUSED PATH — single kernel, best for small K
        ...
        # SEPARATE PATH — tuned gemm_afp4wfp4 for large K
