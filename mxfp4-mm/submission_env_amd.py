...
#!POPCORN gpu MI355X
"""
MXFP4 GEMM — Set AMD Triton compile opts via env vars to affect ALL kernels
including gemm_afp4wfp4 separate path.
"""
import os
# Try setting AMD-specific Triton compile defaults before importing triton
os.environ['TRITON_AMD_WAVES_PER_EU'] = '2'
...
def custom_kernel(data: input_t) -> output_t:
    ...
    if k <= 1024:
        ...
        # gemm_afp4wfp4 may benefit from env var TRITON_AMD_WAVES_PER_EU
