...
# K=7168 with KSPLIT=14: perfect alignment (7168/14=512=BK, exactly 1 iter/split)
# BM=16 from sweeper + .cg cache
_K7168_CONFIG = {
...
# K=2048: try KSPLIT=4 (2048/4=512=BK, perfect alignment)
_K2048_CONFIG = {
    ...
    "cache_modifier": ".cg", "NUM_KSPLIT": 4, "SPLITK_BLOCK_SIZE": 512,
}
