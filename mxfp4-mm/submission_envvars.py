...
#!POPCORN gpu MI355X
"""
GEMM: Triton env vars for block-pingpong + async-copy optimization.
These affect aiter's internal Triton kernels too!
Based on submission_prewarm.py with env var additions.
"""
import os
