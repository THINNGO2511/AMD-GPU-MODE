...
#!POPCORN gpu MI355X
"""
MXFP4 GEMM — KSPLIT=12 for K=7168 (sweep finding: 49.5μs vs 82.2μs baseline = -40%)
Best config: BM=16, BN=64, BK=512, KSPLIT=12, stages=2, waves=2
K=2048: waves=2 (49.9μs vs 50.9μs baseline)
K=1536: quant+afp4wfp4 (unchanged)
K=512: defaults (unchanged)
"""
...
# K=7168: SWEEP WINNER — BM=16, KSPLIT=12 (was BM=8, KSPLIT=8)
_K7168_CONFIG = {
    "BLOCK_SIZE_M": 16, "BLOCK_SIZE_N": 64, "BLOCK_SIZE_K": 512,
    "GROUP_SIZE_M": 1, "num_warps": 4, "num_stages": 2,
    "waves_per_eu": 2, "matrix_instr_nonkdim": 16, "cache_modifier": None,
    "NUM_KSPLIT": 12, "SPLITK_BLOCK_SIZE": 1024,
}

# K=2048: waves=2 (marginal improvement)
_K2048_CONFIG = {
