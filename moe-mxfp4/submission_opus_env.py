...
#!POPCORN gpu MI355X
"""
MoE — AITER_USE_OPUS_MOE_SORTING=1 env var + CU_NUM=256.
The opus sorting kernel (moe_sorting_opus_fwd) may be faster than
the standard moe_sorting_fwd. Combined with CU_NUM=256 for better
CU occupancy, and use_nt=False + CK injection for d<2048.
"""
import os
...
def _patch():
    ...
    # Try setting opus sorting via module attribute too
    try:
        fm._USE_OPUS_MOE_SORTING = True
    except:
        pass

    # CK injection for d<2048
