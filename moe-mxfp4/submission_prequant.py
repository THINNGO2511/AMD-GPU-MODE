...
#!POPCORN gpu MI355X
"""
MoE — Pre-quantize hidden_states to FP4 before calling fused_moe.
Key insight: fused_moe skips internal quant when hidden_states.dtype==fp4x2
and a1_scale is provided. This eliminates 28% of d=2048 kernel time.
"""
import torch
import functools
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # Try pre-quantizing hidden_states for d>=2048 shapes
    # fused_moe skips internal quant when dtype is fp4x2 + a1_scale provided
    a1_scale = None
    input_states = hidden_states

    if config["d_expert"] >= 2048:
        try:
            from aiter.ops.triton.quant import dynamic_mxfp4_quant
            from aiter.utility.fp4_utils import e8m0_shuffle
            a_fp4, a_scale_raw = dynamic_mxfp4_quant(hidden_states)
            input_states = a_fp4  # fp4x2 dtype
            a1_scale = a_scale_raw
        except Exception:
            input_states = hidden_states
            a1_scale = None
    ...
    return fused_moe(
        ...
        a1_scale=a1_scale, a2_scale=None,
