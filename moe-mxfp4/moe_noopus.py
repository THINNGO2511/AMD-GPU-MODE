...
#!POPCORN gpu MI355X
"""
MoE — OPUS sorting disabled.
Competitor "noopus" at 144us explicitly disables OPUS sorting.
Test: monkey-patch _USE_OPUS_MOE_SORTING = False.
Keep CK injection for E<=64 d<2048 (same as optimized_v2).
"""
import torch
import functools
...
def _patch():
    ...
    # KEY CHANGE: Disable OPUS sorting
