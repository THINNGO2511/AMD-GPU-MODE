...
#!POPCORN gpu MI355X
"""
MoE — Try 256x32 tile for bs=128 E=33 (est_m=34) too.
Previous: STAGE1_256 only for est_m>=100, STAGE1_64 for est_m<100.
Now: try STAGE1_256 for est_m>=30 (include bs=128 case).
"""
import torch
import functools
        ...
        if (expert <= 64 and q_type == QuantType.per_1x32
            ...
            try:
                ...
                if not kw.get('kernelName', ''):
                    ...
                    # Try 256x32 for est_m>=30 (was >=100)
                    kn1 = STAGE1_256 if est_m >= 30 else STAGE1_64
