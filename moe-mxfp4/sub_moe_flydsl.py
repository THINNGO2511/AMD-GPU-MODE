import os
# FlyDSL env vars — from Kimi-K2.5 ROCm blog, 28-69% faster than Triton for MoE
...
#!POPCORN gpu MI355X
"""
MoE FlyDSL: Enable FlyDSL kernels via env vars. FlyDSL is 28-69% faster
per Kimi-K2.5 blog. Available on runner (is_flydsl_available()=True).
Base: optimized_v2 + FlyDSL env vars.
"""
import torch
import functools
