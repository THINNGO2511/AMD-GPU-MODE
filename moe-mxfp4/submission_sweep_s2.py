...
#!POPCORN gpu MI355X
"""
MoE — Try stage2 _v3 kernel + Nswizzle variants for d=512 cases.
The _v3 kernel variant might have better tiling for larger N dimensions.
"""
import torch
import functools
...
# Stage 2 kernels - try _v3 instead of _v1
...
S2_v3 = "moe_ck2stages_gemm2_64x32x32x128_1x1_MulABScaleExpertWeightShuffled_v3_Nswizzle0_Quant3_MulRoutedWeight1_FP4X2_FP4X2_B16"
