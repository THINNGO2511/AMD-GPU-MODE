...
#!POPCORN gpu MI355X
"""
MoE — Optimize d=2048 case: try block_m=32 + 64-tile kernel name.
Also keeps d=512 optimization (256x32 tile for large batches).
"""
import torch
import functools
...
def _patch():
    ...
    # For d=2048: try block_m=32 (was 128 default for est_m>=100)
    orig_bsm = fm.get_block_size_M
    fm.get_block_size_M = lambda t, k, e, d: 32 if e <= 64 else orig_bsm(t, k, e, d)
    ...
    def new_get_2stage(token, model_dim, inter_dim, expert, topk,
        ...
        # Inject for ALL E<=64 untuned cases
            ...
            try:
                ...
                if not kw.get('kernelName', ''):
                    ...
                    if inter_dim < 2048:
                        ...
                        # d=2048: use 64-tile with block_m=32
                        kn1 = STAGE1_64
