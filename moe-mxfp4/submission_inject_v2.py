...
#!POPCORN gpu MI355X
"""
MoE — inject_v2: Corrected FP4 kernel names from DSv3 CSV.
Key fix: Stage2 name needs _none_ activation and MulABScaleExpertWeightShuffled.
Correct names:
  Stage1: ...MulABScaleShuffled_v3_..._silu_FP4X2_FP4X2_B16
  Stage2: ...MulABScaleExpertWeightShuffled_v1_..._none_FP4X2_FP4X2_B16
Zero pre-compiled .co files — names trigger JIT compilation.
"""
import torch
import functools
...
# CORRECT kernel names from DSv3 CSV
...
# FIXED: added _none_ before FP4X2
                ...
                if not kw.get('kernelName', ''):
                    ...
                    return fm.MOEMetadata(
                        ...
                        functools.partial(aiter.ck_moe_stage2_fwd,
                            kernelName=S2_64, activation=activation,
