...
#!POPCORN gpu MI355X
"""
GEMM — Selective num_stages=3 for K=512 ONLY (proven -6%).
K=2048/7168 keep stages=2 (stages=3 was +34% worse for K=2048).
K=1536 uses afp4wfp4 path.

Also experiments with BM=4 for M=4 shapes (fewer waves, less scheduling overhead).
"""
import os
...
# K=7168: proven best from sweeper
_K7168_CONFIG = {
...
# K=512: stages=3 experiment (proven -6% for K=512)
_K512_STAGES3_CONFIG = {
...
# K=2048: keep stages=2 (stages=3 was +34% worse)
_K2048_CONFIG = {
...
def _get_config(k):
    ...
    return _K512_STAGES3_CONFIG  # stages=3 for K=512
...
def custom_kernel(data: input_t) -> output_t:
    ...
    if k == 7168:
        ...
        gemm_a16wfp4(A, _bq_u8, _bscale_raw, dtype=torch.bfloat16, y=out, config=_K512_STAGES3_CONFIG)
    return out
