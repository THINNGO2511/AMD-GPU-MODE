...
#!POPCORN gpu MI355X
"""
MLA: HSA_HIGH_PRECISION_MODE=1 — gfx950-only env var for higher-precision MFMA.
If it reduces pg2 mismatch from ~4% to under 3%, pg2 becomes reliable on secret seeds.
Combined with pg2+bf16Q for kv<=1024, pg8+fp8Q for kv>=8192.
"""
import os
os.environ["HSA_HIGH_PRECISION_MODE"] = "1"
