...
#!POPCORN gpu MI355X
"""
MLA: pg1 for ALL shapes (zero accuracy risk). a8w8 for kv>=8192, a16w8 for kv<=1024.
splits=16 everywhere. Completely safe — no pg2/pg8 accuracy gamble.
"""
import torch
import triton
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # ALL pg1 — zero accuracy risk
    use_fp8_q = kv_seq_len > 1024  # fp8 Q for large kv (bandwidth)
    ...
    (wm, wi, wis, ri, rfm, rpm,
     kv_indices, kv_last_page_len, kv_indptr_pg1) = _meta_cache[cache_key]
    ...
    if use_fp8_q:
        ...
        mla_decode_fwd(
            ...
            qo_indptr, kv_indptr_pg1, kv_indices, kv_last_page_len,
