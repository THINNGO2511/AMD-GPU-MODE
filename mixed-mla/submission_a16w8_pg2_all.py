...
#!POPCORN gpu MI355X
"""
MLA — a16w8 + pg2 for ALL sizes.
bf16 Q + fp8 KV + page_size=2. No Q quantization at all.
If a16w8 has better accuracy than a8w8, pg2 mismatch might stay under 5%
even for kv=1024. This would give best of both worlds: no quant overhead
AND pg2 speedup for everything.
"""
import torch
import aiter
