"""
MLA Experiment: a8w8 (fp8 Q) + pg2 for ALL sizes.
Competitor "pg2_fix" uses pg2 everywhere. With a8w8 kernel, fp8 Q reduces
bandwidth for Q reads. pg2 with correct kv_granularity=8.
Fused Triton Q quantization for speed.
"""
import torch
import triton
