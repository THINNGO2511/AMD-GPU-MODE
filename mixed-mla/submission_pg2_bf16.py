...
#!POPCORN gpu MI355X
"""MLA — pg2 + bf16 Q (no Q quantization = guaranteed accuracy)."""
import torch
...
def custom_kernel(data: input_t) -> output_t:
    ...
    if cache_key not in _meta_cache:
        ...
        # Use bf16 Q + fp8 KV
        info = get_mla_metadata_info_v1(batch_size, q_seq_len, nq, BF16, FP8_DTYPE,
    ...
    mla_decode_fwd(
        q, kv_buffer_4d, o,  # q is bf16, no quantization
