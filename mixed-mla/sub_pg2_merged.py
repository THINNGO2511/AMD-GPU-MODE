"""MLA: pg2+fp8Q for kv<=1024 (NEW), exact pg8_v2 code for kv>=8192 (PROVEN)."""
import os
...
def _build_meta(batch_size, kv_seq_len, q_seq_len, nq, nkv,
    ...
    """Build metadata — EXACT same pattern as pg8_v2 for all page sizes."""
...
def custom_kernel(data: input_t) -> output_t:
    ...
    if cache_key not in _meta_cache:
        _meta_cache[cache_key] = _build_meta(
            ...
            num_kv_splits, page_size, FP8_DTYPE, qo_indptr, kv_indptr)
