...
#!POPCORN gpu MI355X
"""
MLA — pg2 with safety: if kv_seq_len not divisible by page_size, fall back to pg1.
Also try: per-size page_size (pg2 for kv=8192, pg1 for kv=1024).
"""
import torch
import triton
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # Use pg2 for all cases (kv_seq_len is always even: 1024 or 8192)
    PAGE_SIZE = 2
    ...
    if cache_key not in _meta_cache:
        ...
        get_mla_metadata_v1(qo_indptr, kv_indptr_pages, kv_last_page_len,
            ...
            page_size=PAGE_SIZE, kv_granularity=8,
