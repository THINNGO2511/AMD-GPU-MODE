"""
MLA: a8w8+pg1 for ALL shapes with optimal kv_splits.
Simpler approach — avoid pg2 accuracy issues entirely.
pg1 is most accurate, a8w8 saves Q bandwidth.
"""
import torch
import triton
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # Optimal splits: 16 for kv>=8192 or large batch, 8 for small
    ...
    if _call_count <= 10:
        print(f"[a8w8-pg1] bs={batch_size} kv={kv_seq_len} splits={num_kv_splits}", file=sys.stderr)
