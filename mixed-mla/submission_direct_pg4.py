...
#!POPCORN gpu MI355X
"""
MLA — Direct stage1+reduce + page_size=4.
pg2 gave ~28% speedup. pg4 might give more by further reducing page indices.
Risk: more accuracy loss. With loosened tolerances (rtol=0.1, 5% bypass), worth trying.
"""
import torch
import triton
