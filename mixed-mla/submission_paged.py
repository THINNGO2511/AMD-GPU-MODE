...
#!POPCORN gpu MI355X
"""
MLA Decode v5 — page_size=16 + fused Q fp8 quant + shape-cached metadata.
Hypothesis: fewer pages = less indirection overhead, better MFMA tiling.
"""
import torch
import triton
...
def custom_kernel(data: input_t) -> output_t:
    ...
    if cache_key not in _meta_cache:
        ...
        total_pages = total_kv_len // PAGE_SIZE

        # Page-level indptr and metadata
    ...
    kv_buffer_4d = kv_buffer_fp8.view(
        total_kv_len // PAGE_SIZE, PAGE_SIZE, nkv, kv_buffer_fp8.shape[-1]
    )
