"""
MLA: Optimized num_kv_splits from sweep results.
a16w8+pg2 for kv<=1024, a8w8+pg8 for kv>=8192.
Sweep found: 16 splits optimal for most shapes, 8 for bs<=32+kv=1024.
"""
import torch
import triton
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # Optimal num_kv_splits from sweep (March 27 Session 9)
