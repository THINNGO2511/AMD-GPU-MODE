...
#!POPCORN gpu MI355X
"""MLA — pg1 + intra_batch_mode=False + per-size splits."""
import torch
import triton
...
def custom_kernel(data: input_t) -> output_t:
    ...
    if cache_key not in _meta_cache:
        ...
        info = get_mla_metadata_info_v1(batch_size, q_seq_len, nq, FP8_DTYPE, FP8_DTYPE,
            is_sparse=False, fast_mode=False, num_kv_splits=num_kv_splits, intra_batch_mode=False)
        ...
        get_mla_metadata_v1(qo_indptr, kv_indptr, kv_last_page_len,
            ...
            intra_batch_mode=False, dtype_q=FP8_DTYPE, dtype_kv=FP8_DTYPE)
    ...
    mla_decode_fwd(
        ...
        q_scale=scale_buf, kv_scale=kv_scale, intra_batch_mode=False,
