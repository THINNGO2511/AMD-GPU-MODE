...
#!POPCORN gpu MI355X
"""
MLA — page_size=2 v2: try different num_kv_splits tuning with pg2.
The pg2 reduces pages by 2x → more parallelism per split.
Try: fewer splits since pg2 already reduces overhead.
"""
import torch
import triton
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # With pg2, pages are halved → can use fewer splits
    ...
    if cache_key not in _meta_cache:
        ...
        num_pages_total = (total_kv_len + PAGE_SIZE - 1) // PAGE_SIZE
