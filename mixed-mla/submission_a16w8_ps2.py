...
#!POPCORN gpu MI355X
"""
MLA — bf16 Q + fp8 KV + page_size=2 (a16w8_ps2 approach).
Confirmed working by competitor olezhka_007 at rank 12 (54.3us).
bf16 Q avoids fp8 quantization error that kills pg2 accuracy.
No Q quant kernels needed -> saves 2 kernel launches.
"""
import torch
