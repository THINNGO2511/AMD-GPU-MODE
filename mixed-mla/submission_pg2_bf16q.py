...
#!POPCORN gpu MI355X
"""
MLA — page_size=2 with bf16 Q (no Q quantization = better accuracy).
pg2 gave 51μs geomean but ranked failed (error 0.09 near tolerance).
Using bf16 Q should reduce error while keeping the pg2 speed benefit.
"""
import torch
import triton
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # Use fp8 Q + fp8 KV with page_size=2
    use_fp8_q = True
    q_dtype = FP8_DTYPE if use_fp8_q else BF16_DTYPE
    kv_dtype = FP8_DTYPE
