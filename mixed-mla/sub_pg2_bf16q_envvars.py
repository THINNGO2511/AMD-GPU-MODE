...
#!POPCORN gpu MI355X
"""
MLA pg2+bf16Q + AMD environment variables for reduced kernel launch latency.
HIP_FORCE_DEV_KERNARG=1 — forces device kernel arguments (6μs reduction on vLLM)
GPU_MAX_HW_QUEUES=2 — limits hardware queues
HSA_NO_SCRATCH_RECLAIM=1 — prevents scratch memory reclamation overhead
"""
import os
