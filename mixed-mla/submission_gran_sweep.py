...
#!POPCORN gpu MI355X
"""
MLA — Try different kv_granularity values + per-size splits.
kv_granularity controls scheduling granularity of KV blocks.
"""
import torch
import triton
...
def custom_kernel(data: input_t) -> output_t:
    ...
    # Try larger kv_granularity for better scheduling
    kv_gran = 32  # was 16

    cache_key = (batch_size, kv_seq_len, num_kv_splits, kv_gran)
