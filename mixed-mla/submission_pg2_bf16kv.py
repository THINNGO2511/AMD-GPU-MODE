...
#!POPCORN gpu MI355X
"""MLA — pg2 + fp8 Q + bf16 KV (eliminates KV quant error for better accuracy)."""
import torch
import triton
...
def custom_kernel(data: input_t) -> output_t:
    ...
    if cache_key not in _meta_cache:
        ...
        info = get_mla_metadata_info_v1(batch_size, q_seq_len, nq, q_dtype, kv_dtype,
    ...
    kv_buffer_4d = kv_buffer_bf16.view(-1, PAGE_SIZE, nkv, kv_buffer_bf16.shape[-1])
    ...
    mla_decode_fwd(
        ...
        q_scale=scale_buf, intra_batch_mode=True,
